...
?>
    ...
    <li><a href="rp_home.php"><i class="fas fa-home"></i></i>Page d'acceuil</a></li>
     <li><a href="listeemployes.php"><i class="fas fa-money-bill-alt"></i>Gestion des salaires</a></li>
     <li><a href="ReclamationRp.php"><i class="fas fa-exclamation-circle"></i>Gestion des reclamations</a></li>
     <li><a href="viewRubr.php"><i class="fas fa-money-check-alt"></i>Gestion des rubriques</a></li>
     <li><a href="gestionRegle.php"><i class="fas fa-exclamation-circle"></i>Gestion des regles</a></li>
     <li><a href="gestionRubr.php"><i class="fas fa-money-check-alt"></i>Affectation des regles</a></li>
     <li><a href="../fpdf/bull.php"><i class="fas fa-file-invoice-dollar"></i>Bulletins de paie</a></li>
    </ul>
   </div>
    <nav class="nav_trsp">
        <ul>
